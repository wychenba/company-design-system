...
export const Accessibility = {
  ...
  render: () => (
    <div className="max-w-3xl text-body text-fg-secondary">
      ...
      <p className="whitespace-pre-line">{"[TODO] 本元件 spec.md 尚無「## A11y 預設」段。後續補:ARIA role / keyboard map / focus 行為。對齊 OverflowIndicator 對應 Radix / Material / Polaris a11y 規範。"}</p>
    </div>
  ),
}
